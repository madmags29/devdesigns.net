...
import { Server, CheckCircle2, ArrowRight, ShieldCheck } from "lucide-react";
...
export default function DomainHostingPage() {
    ...
    useEffect(() => {
        async function fetchImages() {
            try {
                const photos = await searchPhotos("server room data center technology", 2);
                    ...
                    <div className="max-w-4xl mx-auto text-center">
                        ...
                        >
                            <h1 className="text-4xl md:text-6xl font-heading font-bold text-primary mb-6 text-shadow-sm">
                                Reliable <span className="text-accent underline decoration-slate-200 decoration-4 underline-offset-4">Domain & Hosting</span>
                            </h1>
                            <p className="text-xl text-slate-800 leading-relaxed mb-10 font-medium">
                                Secure, high-speed infrastructure designed for modern websites. From domain registration to managed cloud hosting, we ensure your site is always online and lightning-fast.
                            </p>
                            <Link
                                href="/contact"
                            ...
                            >
                                Secure Your Domain <ArrowRight size={20} />
                            </Link>
                        </motion.div>
                    </div>
                </div>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                        <div>
                            <h2 className="text-3xl md:text-4xl font-heading font-bold text-primary mb-6">
                                Foundation for Your Digital Success
                            </h2>
                            <p className="text-lg text-slate-600 mb-8">
                                A great website deserves great hosting. We provide localized and global hosting solutions that prioritize uptime, security, and speed. Our managed services take the technical headache out of server management so you can focus on your business.
                            </p>
                            <div className="space-y-4">
                                {[
                                    "Premium Domain Registration (.com, .in, .net, etc.)",
                                    "Managed Cloud Hosting (AWS, GCP, Digital Ocean)",
                        ...
                        <div className="relative group">
                            <div className="bg-accent/5 rounded-3xl overflow-hidden aspect-square flex items-center justify-center relative shadow-2xl border border-slate-100">
                                {detailImage ? (
                                    ...
                                    <Server size={120} className="text-accent animate-pulse" />
                                )}
                            ...
                            <div className="absolute -bottom-6 -right-6 bg-white p-6 rounded-2xl shadow-xl border border-slate-100 max-w-xs group-hover:-translate-y-2 transition-transform">
                                <p className="text-sm font-bold text-primary italic">
                                    &quot;Our site performance improved by 200% after moving to DevDesigns managed hosting. Highly recommended!&quot;
                                </p>
                                <p className="text-xs text-slate-400 mt-2">— Sarah Jenkins, Founder of TechStart</p>
                            </div>
                        </div>
                    </div>
                </div>
