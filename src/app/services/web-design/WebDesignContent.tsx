...
export default function WebDesignContent() {
    ...
    useEffect(() => {
        async function fetchImages() {
            try {
                const photos = await searchPhotos("modern web design agency", 2);
                    ...
                    <div className="max-w-4xl mx-auto text-center">
                        ...
                        >
                            <h1 className="text-4xl md:text-6xl font-heading font-bold text-primary mb-6 text-shadow-sm">
                                Premium <span className="text-accent underline decoration-slate-200 decoration-4 underline-offset-4">Web Design</span> Services
                            </h1>
                            <p className="text-xl text-slate-800 leading-relaxed mb-10 font-medium">
                                Transform your brand with stunning, user-centric designs that engage visitors and drive conversions. We create websites that are as beautiful as they are functional.
                            </p>
                            <Link
                                href="/contact"
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                        <div>
                            ...
                            <p className="text-lg text-slate-600 mb-8">
                                In today&apos;s digital landscape, your website is often the first point of contact between your brand and potential customers. A professional design does more than just look good—it builds trust, improves user experience, and sets you apart from the competition.
                            </p>
                            <div className="space-y-4">
                                {[
                                    "Responsive Design for all devices",
                                    "User-Centric UX/UI focus",
                        ...
                        <div className="relative group">
                            <div className="bg-accent/5 rounded-3xl overflow-hidden aspect-square flex items-center justify-center relative shadow-2xl border border-slate-100">
                                {detailImage ? (
                                    ...
                                    <Layout size={120} className="text-accent animate-pulse" />
                                )}
                            ...
                            <div className="absolute -bottom-6 -right-6 bg-white p-6 rounded-2xl shadow-xl border border-slate-100 max-w-xs group-hover:-translate-y-2 transition-transform">
                                <p className="text-sm font-bold text-primary italic">
                                    &quot;Working with DevDesigns transformed our online presence. Our conversion rate increased by 40% after the redesign.&quot;
                                </p>
                                <p className="text-xs text-slate-400 mt-2">— Sarah Johnson, CEO of TechFlow</p>
                            </div>
                        </div>
                    </div>
                </div>
